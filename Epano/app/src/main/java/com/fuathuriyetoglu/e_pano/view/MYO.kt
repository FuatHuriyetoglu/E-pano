...
class MYO : AppCompatActivity() {
    private lateinit var binding :ActivityMyoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMyoBinding.inflate(layoutInflater)
    ...
    private fun getData(){
        db.collection("MyoDocuments").orderBy("date", Query.Direction.DESCENDING).addSnapshotListener{ value, error ->
            if(error != null){
